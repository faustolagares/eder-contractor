    ...
    >
      ...
      <section className="w-full overflow-hidden bg-[url('https://cdn.prod.website-files.com/646ef7a4c51366af95b5a706/6474705a0cfc7c59037c45f6_Number%20Talks%20Bg.png')] bg-no-repeat bg-cover py-20 md:py-32 lg:py-40 relative" id="section-1">
        <div className="w-full max-w-7xl mx-auto px-4 md:px-8 lg:px-12">
          <div className="w-full flex flex-col lg:flex-row items-center justify-start gap-8 lg:gap-0" id="div-1">
            ...
            <div className="w-full lg:w-1/2 shrink-0" id="div-5">
              <div className="w-full">
                <div className="box-border text-black/[0.8] text-lg auto-cols-fr grid-cols-[1fr_1fr] grid-rows-[auto] w-full leading-5 grid gap-5">
