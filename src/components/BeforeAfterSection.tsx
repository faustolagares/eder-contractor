...
const BeforeAfterSection = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      beforeImage: '/assets/photos/Before-After/fence-before.jpeg',
      afterImage: '/assets/photos/Before-After/fence-after.jpeg',
      title: t('beforeAfter.projects.project3.title'),
      category: t('beforeAfter.projects.project3.category'),
    },
    {
      id: 'deck-installation',
      beforeImage: '/assets/photos/Before-After/deck-before.jpeg',
      afterImage: '/assets/photos/Before-After/deck-after.jpeg',
